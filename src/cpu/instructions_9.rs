...
fn _98_sbc_a_b() {
    ...
    // set the program counter
    test_cpu.register_pc = 0xC000;
    test_cpu.write_program(vec!(0x98), 0xC000);
    let cycles = test_cpu.tic(); 
    assert_eq!(test_cpu.a(), 4); 
    assert_eq!(cycles, 4);
    assert_eq!(test_cpu.register_pc, 0xC001);   
}

#[test]
fn _98_sbc_a_b_carry() {
    // b = 15, a = 10
    // SUB A,B -> 5
    let mut test_cpu: CPU = CPU::default();
    // set the registers
...
fn _99_sbc_a_c() {
    ...
    // set the program counter
    test_cpu.register_pc = 0xC000;
    test_cpu.write_program(vec!(0x99), 0xC000);
    let cycles = test_cpu.tic(); 
    assert_eq!(test_cpu.a(), 4); 
    assert_eq!(cycles, 4);
    assert_eq!(test_cpu.register_pc, 0xC001);   
...
fn _9a_sbc_a_d() {
    ...
    // set the program counter
    test_cpu.register_pc = 0xC000;
    test_cpu.write_program(vec!(0x9A), 0xC000);
    let cycles = test_cpu.tic(); 
    assert_eq!(test_cpu.a(), 4); 
    assert_eq!(cycles, 4);
    assert_eq!(test_cpu.register_pc, 0xC001);   
...
fn _9b_sbc_a_e() {
    ...
    // set the program counter
    test_cpu.register_pc = 0xC000;
    test_cpu.write_program(vec!(0x9B), 0xC000);
    let cycles = test_cpu.tic(); 
    assert_eq!(test_cpu.a(), 4); 
    assert_eq!(cycles, 4);
    assert_eq!(test_cpu.register_pc, 0xC001);   
...
fn _9c_sub_a_h() {
    ...
    // set the program counter
    test_cpu.register_pc = 0xC000;
    test_cpu.write_program(vec!(0x9C), 0xC000);
    let cycles = test_cpu.tic(); 
    assert_eq!(test_cpu.a(), 4); 
    assert_eq!(cycles, 4);
    assert_eq!(test_cpu.register_pc, 0xC001);   
...
fn _9d_sub_a_l() {
    ...
    // set the program counter
    test_cpu.register_pc = 0xC000;
    test_cpu.write_program(vec!(0x9D), 0xC000);
    let cycles = test_cpu.tic(); 
    assert_eq!(test_cpu.a(), 4); 
    assert_eq!(cycles, 4);
    assert_eq!(test_cpu.register_pc, 0xC001);   
...
fn _9e_sub_a_phl() {
    ...
    // set the program counter
    test_cpu.register_pc = 0xC000;
    test_cpu.write_program(vec!(0x9E), 0xC000);
    let cycles = test_cpu.tic(); 
    assert_eq!(test_cpu.a(), 4); 
    assert_eq!(cycles, 8);
    assert_eq!(test_cpu.register_pc, 0xC001);   
...
fn _9f_sbc_a_a() {
    ...
    // set the program counter
    test_cpu.register_pc = 0xC000;
    test_cpu.write_program(vec!(0x9f), 0xC000);
    let cycles = test_cpu.tic(); 
    assert_eq!(test_cpu.a(), 0xFF); 
